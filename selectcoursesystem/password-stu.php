...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE student SET stupassword=%s WHERE stuid=%s",
...
<form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="400" border="1" align="center">
    ...
    <tr>
      ...
      <td align="center"><input name="stupassword" type="text" id="stupassword" value="<?php echo $_SESSION['STU_Userpassword']; ?>" size="15" /></td>
    </tr>
    <tr>
